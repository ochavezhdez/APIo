angular.module('controllers.apio', ['services.apio'])
	...
	.controller('restaurantPutCtrl', RestaurantPutCtrl)
...
function RestaurantDetailsCtrl ($scope, $http, $routeParams, restaurant, saucer) {
	restaurant.getRestaurantById($routeParams.id);
	// ok
...
function RestaurantPutCtrl ($scope, $http, $routeParams, restaurant, saucer) {
